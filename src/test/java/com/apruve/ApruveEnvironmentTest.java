...
public class ApruveEnvironmentTest {
	...
	public void testApiUrl() {
		assertEquals("https://app.apruve.com/api/v3", ApruveEnvironment.PROD.getApiV3Url());
		assertEquals("https://test.apruve.com/api/v3", ApruveEnvironment.TEST.getApiV3Url());
	}
	
	@Test
	public void testJsUrl() {
		assertEquals("https://app.apruve.com/js/apruve.js", ApruveEnvironment.PROD.getJsUrl());
		assertEquals("https://test.apruve.com/js/apruve.js", ApruveEnvironment.TEST.getJsUrl());
	}
	
	@Test
	public void testJsTag() {
		assertEquals("<script src=\"https://app.apruve.com/js/apruve.js\" type=\"text/javascript\"></script>", ApruveEnvironment.PROD.getJsTag());
